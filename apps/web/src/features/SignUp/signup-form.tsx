...
export default function SignUpForm({ onSignUpSuccess }: SignUpFormProps) {
    ...
    return <Card className="w-full max-w-md">
        ...
        <CardContent>
            <form id="signupForm" onSubmit={async (e) => {
                e.preventDefault();
                try {
                    await handleSubmit()
                    onSignUpSuccess();
                    ...
                    <div className="grid gap-6">
                        ...
                        <div className="grid gap-3">
                            ...
                            <div className="relative">
                                <Input    {...register("password")} id="password" type={passwordVisible ? "text" : "password"} placeholder="Create Password" />
                                <button className="absolute right-3 top-3" onClick={(e) => {
                                    e.preventDefault();
                                    setPasswordVisible(!passwordVisible);
                                }}>
                                    {passwordVisible ?
                                        <Eye className=" text-balck h-4 w-4" /> : <EyeOffIcon className=" text-balck h-4 w-4" />}
